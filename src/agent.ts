...
export function createSystemPrompt(
  ...
  parts.push(
    ...
    `- PATH RESOLUTION: You can access any path on the system via command (ls, cat, find). Don't assume a path doesn't exist — check with ls. If a relative path fails, try ~/expansion.`,
